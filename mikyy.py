...
def bot():
	...
	jumlah = int(input(f"Jumlah Share : "))
	print("Share Sedang Berjalan , Harap Tunggu")
	...
	try:
		...
		for x in range(jumlah):
			...
			if "id" in post:
				...
				print(f'[●]{n}.Share Berhasil\n',end='');sys.stdout.flush()
			else:
				print("\n")
				pritn("Share Berhenti Kemungkinan Cookie atau Akun Facebook di Tangguhkan")
